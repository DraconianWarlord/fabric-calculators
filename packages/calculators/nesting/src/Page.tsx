...
export default function NestingPage() {
  ...
  return (
    <div className="calc-page calc-page--nesting">
      ...
      <div className={`layout mobile-${mobileView}`}>
        <aside className="sidebar left" data-mobile-pane="controls">
          ...
          <Collapsible title="Add Panel" open={openAdd} onToggle={() => setOpenAdd((v) => !v)}>
            ...
            {draftKind === 'circle' && <CircleDimPreview />}
            {draftKind === 'trap' && <TrapDimPreview />}
            {draftKind === 'irregular' && <IrregularDimPreview />}
            {draftKind === 'rect' && <RectDimPreview />}
            {draftKind === 'rect' ? (
              <>
                <label>
